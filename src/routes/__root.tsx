...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "SOMNIA AI — Decode Your Sleep. Understand Your Health." },
      { property: "og:description", content: "AI-powered analysis of sleep and neurological patterns for intelligent early-stage health screening." },
